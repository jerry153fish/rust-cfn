...
pub mod component_type {
    ...
    pub struct DataValue {
        ...
        /// Update type: _Mutable_.
        /// AWS CloudFormation doesn't replace the resource when you change this property.
        pub relationship_value: Option<::Value<::json::Value>>,
        ...
        fn deserialize<'de, D: ::serde::Deserializer<'de>>(d: D) -> Result<DataValue, D::Error> {
            ...
            impl<'de> ::serde::de::Visitor<'de> for Visitor {
                ...
                fn visit_map<A: ::serde::de::MapAccess<'de>>(self, mut map: A) -> Result<Self::Value, A::Error> {
                    ...
                    let mut relationship_value: Option<::Value<::json::Value>> = None;
...
pub mod entity {
    ...
    pub struct Status {
        ...
        /// Update type: _Mutable_.
        /// AWS CloudFormation doesn't replace the resource when you change this property.
        pub error: Option<::Value<::json::Value>>,
    ...
    impl ::codec::DeserializeValue for Status {
        fn deserialize<'de, D: ::serde::Deserializer<'de>>(d: D) -> Result<Status, D::Error> {
            ...
            impl<'de> ::serde::de::Visitor<'de> for Visitor {
                ...
                fn visit_map<A: ::serde::de::MapAccess<'de>>(self, mut map: A) -> Result<Self::Value, A::Error> {
                    let mut error: Option<::Value<::json::Value>> = None;
