...
pub struct StreamProcessorProperties {
    ...
    /// Update type: _Immutable_.
    /// AWS CloudFormation replaces the resource when you change this property.
    pub polygon_regions_of_interest: Option<::ValueList<self::stream_processor::Point>>,
...
impl<'de> ::serde::Deserialize<'de> for StreamProcessorProperties {
    fn deserialize<D: ::serde::Deserializer<'de>>(
        d: D,
    ) -> Result<StreamProcessorProperties, D::Error> {
        struct Visitor;
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A: ::serde::de::MapAccess<'de>>(
                ...
                let mut bounding_box_regions_of_interest: Option<
                    ::ValueList<self::stream_processor::BoundingBox>,
                > = None;
                let mut connected_home_settings: Option<
                    ::Value<self::stream_processor::ConnectedHomeSettings>,
                > = None;
                let mut data_sharing_preference: Option<
                    ::Value<self::stream_processor::DataSharingPreference>,
                > = None;
                let mut face_search_settings: Option<
                    ::Value<self::stream_processor::FaceSearchSettings>,
                > = None;
                let mut kinesis_data_stream: Option<
                    ::Value<self::stream_processor::KinesisDataStream>,
                > = None;
                let mut kinesis_video_stream: Option<
                    ::Value<self::stream_processor::KinesisVideoStream>,
                > = None;
                let mut kms_key_id: Option<::Value<String>> = None;
                let mut name: Option<::Value<String>> = None;
                let mut notification_channel: Option<
                    ::Value<self::stream_processor::NotificationChannel>,
                > = None;
                let mut polygon_regions_of_interest: Option<
                    ::ValueList<self::stream_processor::Point>,
                > = None;
                let mut role_arn: Option<::Value<String>> = None;
                let mut s3_destination: Option<::Value<self::stream_processor::S3Destination>> =
                    None;
                let mut tags: Option<::ValueList<::Tag>> = None;
                ...
                Ok(StreamProcessorProperties {
                    ...
                    kinesis_video_stream: kinesis_video_stream
                        .ok_or(::serde::de::Error::missing_field("KinesisVideoStream"))?,
...
pub mod stream_processor {
    ...
    impl ::codec::DeserializeValue for ConnectedHomeSettings {
        fn deserialize<'de, D: ::serde::Deserializer<'de>>(
            d: D,
        ) -> Result<ConnectedHomeSettings, D::Error> {
            struct Visitor;
    ...
    impl ::codec::DeserializeValue for DataSharingPreference {
        fn deserialize<'de, D: ::serde::Deserializer<'de>>(
            d: D,
        ) -> Result<DataSharingPreference, D::Error> {
            struct Visitor;
    ...
    impl ::codec::DeserializeValue for FaceSearchSettings {
        fn deserialize<'de, D: ::serde::Deserializer<'de>>(
            d: D,
        ) -> Result<FaceSearchSettings, D::Error> {
            struct Visitor;
    ...
    impl ::codec::DeserializeValue for KinesisDataStream {
        fn deserialize<'de, D: ::serde::Deserializer<'de>>(
            d: D,
        ) -> Result<KinesisDataStream, D::Error> {
            struct Visitor;
    ...
    impl ::codec::DeserializeValue for KinesisVideoStream {
        fn deserialize<'de, D: ::serde::Deserializer<'de>>(
            d: D,
        ) -> Result<KinesisVideoStream, D::Error> {
            struct Visitor;
    ...
    impl ::codec::DeserializeValue for NotificationChannel {
        fn deserialize<'de, D: ::serde::Deserializer<'de>>(
            d: D,
        ) -> Result<NotificationChannel, D::Error> {
            struct Visitor;
    ...
    /// The [`AWS::Rekognition::StreamProcessor.Point`](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-rekognition-streamprocessor-point.html) property type.
    #[derive(Debug, Default)]
    pub struct Point {
        /// Property [`X`](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-rekognition-streamprocessor-point.html#cfn-rekognition-streamprocessor-point-x).
        ///
        /// Update type: _Immutable_.
        /// AWS CloudFormation replaces the resource when you change this property.
        pub x: ::Value<f64>,
        /// Property [`Y`](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-rekognition-streamprocessor-point.html#cfn-rekognition-streamprocessor-point-y).
        ///
        /// Update type: _Immutable_.
        /// AWS CloudFormation replaces the resource when you change this property.
        pub y: ::Value<f64>,
    ...
    impl ::codec::SerializeValue for Point {
        fn serialize<S: ::serde::Serializer>(&self, s: S) -> Result<S::Ok, S::Error> {
            let mut map = ::serde::Serializer::serialize_map(s, None)?;
            ::serde::ser::SerializeMap::serialize_entry(&mut map, "X", &self.x)?;
            ::serde::ser::SerializeMap::serialize_entry(&mut map, "Y", &self.y)?;
            ::serde::ser::SerializeMap::end(map)
        }
    }

    impl ::codec::DeserializeValue for Point {
        fn deserialize<'de, D: ::serde::Deserializer<'de>>(d: D) -> Result<Point, D::Error> {
            struct Visitor;
            ...
            impl<'de> ::serde::de::Visitor<'de> for Visitor {
                ...
                fn expecting(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
                    write!(f, "a struct of type Point")
                }
                ...
                fn visit_map<A: ::serde::de::MapAccess<'de>>(
                    ...
                    let mut x: Option<::Value<f64>> = None;
                    let mut y: Option<::Value<f64>> = None;
                        ...
                        ::serde::de::MapAccess::next_key::<String>(&mut map)?
                    {
                        match __cfn_key.as_ref() {
                            "X" => {
                                x = ::serde::de::MapAccess::next_value(&mut map)?;
                            }
                            "Y" => {
                                y = ::serde::de::MapAccess::next_value(&mut map)?;
                            }
                            _ => {}
                        }
                    }
                    ...
                    Ok(Point {
                        x: x.ok_or(::serde::de::Error::missing_field("X"))?,
                        y: y.ok_or(::serde::de::Error::missing_field("Y"))?,
                    })
                }
            }
