...
pub mod stack_set {
    ...
    pub struct DeploymentTargets {
        /// Property [`AccountFilterType`](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-cloudformation-stackset-deploymenttargets.html#cfn-cloudformation-stackset-deploymenttargets-accountfiltertype).
        ///
        /// Update type: _Mutable_.
        /// AWS CloudFormation doesn't replace the resource when you change this property.
        pub account_filter_type: Option<::Value<String>>,
    ...
    impl ::codec::SerializeValue for DeploymentTargets {
        fn serialize<S: ::serde::Serializer>(&self, s: S) -> Result<S::Ok, S::Error> {
            let mut map = ::serde::Serializer::serialize_map(s, None)?;
            if let Some(ref account_filter_type) = self.account_filter_type {
                ::serde::ser::SerializeMap::serialize_entry(&mut map, "AccountFilterType", account_filter_type)?;
            }
    ...
    impl ::codec::DeserializeValue for DeploymentTargets {
        fn deserialize<'de, D: ::serde::Deserializer<'de>>(d: D) -> Result<DeploymentTargets, D::Error> {
            ...
            impl<'de> ::serde::de::Visitor<'de> for Visitor {
                ...
                fn visit_map<A: ::serde::de::MapAccess<'de>>(self, mut map: A) -> Result<Self::Value, A::Error> {
                    let mut account_filter_type: Option<::Value<String>> = None;
                    ...
                    while let Some(__cfn_key) = ::serde::de::MapAccess::next_key::<String>(&mut map)? {
                        match __cfn_key.as_ref() {
                            "AccountFilterType" => {
                                account_filter_type = ::serde::de::MapAccess::next_value(&mut map)?;
                            }
                            "Accounts" => {
