...
pub struct RouteProperties {
    ...
    /// Property [`DefaultRoute`](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-refactorspaces-route.html#cfn-refactorspaces-route-defaultroute).
    ///
    /// Update type: _Mutable_.
    /// AWS CloudFormation doesn't replace the resource when you change this property.
    pub default_route: Option<::Value<self::route::DefaultRouteInput>>,
...
impl ::serde::Serialize for RouteProperties {
    fn serialize<S: ::serde::Serializer>(&self, s: S) -> Result<S::Ok, S::Error> {
        ...
        if let Some(ref default_route) = self.default_route {
            ::serde::ser::SerializeMap::serialize_entry(&mut map, "DefaultRoute", default_route)?;
        }
    ...
    fn deserialize<D: ::serde::Deserializer<'de>>(d: D) -> Result<RouteProperties, D::Error> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A: ::serde::de::MapAccess<'de>>(self, mut map: A) -> Result<Self::Value, A::Error> {
                ...
                let mut default_route: Option<::Value<self::route::DefaultRouteInput>> = None;
                let mut environment_identifier: Option<::Value<String>> = None;
                ...
                while let Some(__cfn_key) = ::serde::de::MapAccess::next_key::<String>(&mut map)? {
                    match __cfn_key.as_ref() {
                        ...
                        "DefaultRoute" => {
                            default_route = ::serde::de::MapAccess::next_value(&mut map)?;
                        }
                        "EnvironmentIdentifier" => {
                            environment_identifier = ::serde::de::MapAccess::next_value(&mut map)?;
                        }
...
pub mod route {
    ...
    /// The [`AWS::RefactorSpaces::Route.DefaultRouteInput`](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-refactorspaces-route-defaultrouteinput.html) property type.
    #[derive(Debug, Default)]
    pub struct DefaultRouteInput {
        /// Property [`ActivationState`](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-refactorspaces-route-defaultrouteinput.html#cfn-refactorspaces-route-defaultrouteinput-activationstate).
        ///
        /// Update type: _Mutable_.
        /// AWS CloudFormation doesn't replace the resource when you change this property.
    ...
    impl ::codec::SerializeValue for DefaultRouteInput {
        fn serialize<S: ::serde::Serializer>(&self, s: S) -> Result<S::Ok, S::Error> {
            let mut map = ::serde::Serializer::serialize_map(s, None)?;
    ...
    impl ::codec::DeserializeValue for DefaultRouteInput {
        fn deserialize<'de, D: ::serde::Deserializer<'de>>(d: D) -> Result<DefaultRouteInput, D::Error> {
            struct Visitor;

            impl<'de> ::serde::de::Visitor<'de> for Visitor {
                type Value = DefaultRouteInput;

                fn expecting(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
                    write!(f, "a struct of type DefaultRouteInput")
                }
