...
pub struct CRLProperties {
    ...
    pub crl_data: Option<::Value<String>>,
...
impl ::serde::Serialize for CRLProperties {
    fn serialize<S: ::serde::Serializer>(&self, s: S) -> Result<S::Ok, S::Error> {
        ...
        if let Some(ref crl_data) = self.crl_data {
            ::serde::ser::SerializeMap::serialize_entry(&mut map, "CrlData", crl_data)?;
        }
...
pub struct ProfileProperties {
    ...
    /// Update type: _Mutable_.
    /// AWS CloudFormation doesn't replace the resource when you change this property.
    pub role_arns: Option<::ValueList<String>>,
...
impl ::serde::Serialize for ProfileProperties {
    fn serialize<S: ::serde::Serializer>(&self, s: S) -> Result<S::Ok, S::Error> {
        ...
        if let Some(ref role_arns) = self.role_arns {
            ::serde::ser::SerializeMap::serialize_entry(&mut map, "RoleArns", role_arns)?;
        }
...
pub struct TrustAnchorProperties {
    ...
    /// Update type: _Mutable_.
    /// AWS CloudFormation doesn't replace the resource when you change this property.
    pub source: Option<::Value<self::trust_anchor::Source>>,
