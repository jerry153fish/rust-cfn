...
pub struct EndpointAccessProperties {
    ...
    /// Property [`VpcEndpoint`](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-redshift-endpointaccess.html#cfn-redshift-endpointaccess-vpcendpoint).
    ///
    /// Update type: _Mutable_.
    /// AWS CloudFormation doesn't replace the resource when you change this property.
    pub vpc_endpoint: Option<::Value<::json::Value>>,
    ...
    /// Property [`VpcSecurityGroups`](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-redshift-endpointaccess.html#cfn-redshift-endpointaccess-vpcsecuritygroups).
    ///
    /// Update type: _Mutable_.
    /// AWS CloudFormation doesn't replace the resource when you change this property.
    pub vpc_security_groups: Option<::ValueList<self::endpoint_access::VpcSecurityGroup>>,
}
    ...
    fn deserialize<D: ::serde::Deserializer<'de>>(d: D) -> Result<EndpointAccessProperties, D::Error> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A: ::serde::de::MapAccess<'de>>(self, mut map: A) -> Result<Self::Value, A::Error> {
                ...
                let mut vpc_endpoint: Option<::Value<::json::Value>> = None;
                let mut vpc_security_group_ids: Option<::ValueList<String>> = None;
                let mut vpc_security_groups: Option<::ValueList<self::endpoint_access::VpcSecurityGroup>> = None;
